...
func TestHTMLConditionalBranches(t *testing.T) {
	for _, tt := range []struct{ name, input, want string }{
		...
		{"self-closing noscript conditional", `<noscript/><![if false]><p>Fallback</p><![endif]><p>Body</p>`, "Body"},
		{"self-closing uppercase noscript", `<NOSCRIPT /><![if false]><p>Fallback</p><![endif]><p>Body</p>`, "Body"},
		{"self-closing noscript visible branch", `<noscript/><![if !mso]><p>Normal</p><![endif]><p>Body</p>`, "Normal\n\nBody"},
