...
- `docker build -t gmail-telegram-bot .`: build the container image.
- `docker run --env-file .env -p 8080:8080 gmail-telegram-bot`: run the app in Docker.
